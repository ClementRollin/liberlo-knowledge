...
const services = [
  {
    name: 'IT',
    slug: 'it',
    description: 'Infrastructure, outils et support technique',
    icon: '💻',
  ...
  },
  {
    name: 'CSM',
    slug: 'csm',
    description: 'Suivi praticiens, support et fidélisation',
    icon: '🤝',
  ...
  },
  {
    name: 'Sales',
    slug: 'sales',
    description: 'Acquisition, pitch et process commercial',
    icon: '📈',
  ...
  },
  {
    name: 'Marketing',
    slug: 'marketing',
    description: 'Marque, contenus et acquisition organique',
    icon: '🎨',
  ...
  },
  {
    name: 'RH',
    slug: 'rh',
    description: 'Recrutement, onboarding et politique RH',
    icon: '👥',
  ...
  },
  {
    name: 'Direction',
    slug: 'direction',
    description: 'Stratégie, OKR et gouvernance',
    icon: '🧭',
...
<template>
  <!-- Maquette Figma : frame "Home" (1:3) -->
  <div class="min-h-screen flex flex-col bg-white">
    <AppHeader />

    <main class="flex-1 flex flex-col items-center pb-16">
      <!-- Title section -->
      <div class="flex flex-col items-center mt-[140px] gap-4 max-w-[560px] px-6 text-center">
      ...
      <form @submit.prevent="search" class="mt-10 w-full max-w-[740px] px-6">
        <div class="flex items-center h-[68px] border border-gray-200 rounded-2xl px-6 gap-4 shadow-sm focus-within:border-[#6b2fa0] focus-within:shadow-[0_0_0_3px_rgba(107,47,160,0.08)] transition-all">
          ...
          <button
            v-if="query"
            type="submit"
            class="shrink-0 px-5 py-2 rounded-xl bg-[#6b2fa0] text-white text-sm font-medium hover:bg-[#5a2787] transition-colors"
          >
            Rechercher
          </button>
        </div>
      ...
      <!-- Services grid -->
      <section class="mt-14 w-full max-w-[1200px] px-6">
        ...
        <div class="grid grid-cols-3 gap-5">
          <RouterLink
            ...
            :class="[
              'group rounded-2xl border p-6 bg-gradient-to-br hover:shadow-md transition-all duration-200',
              service.color,
              service.border,
            ]"
          >
